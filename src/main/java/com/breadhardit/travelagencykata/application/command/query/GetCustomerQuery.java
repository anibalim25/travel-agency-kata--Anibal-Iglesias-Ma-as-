...
public class GetCustomerQuery {
  ...
  public Optional<Customer> handle() {
    ...
    if (!StringUtils.hasText(id)) {
      return customersRepository.getCustomerByPassport(
          passport); // @TODO antes el método getCustomerByPassport() recibia id en vez de passport
      // lo que hacía que la busqueda por pasaporte nunca devolviera nada.
    }
